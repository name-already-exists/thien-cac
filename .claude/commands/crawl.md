Crawl a story from metruyenchuvn.com in 2 steps: discover then 4 parallel instances.
...
```
cd thien-dao/crawlers/metruyenchuvn-crawler
...
- The slug is the last path segment of the URL (e.g. `tien-nghich` from `https://metruyenchuvn.com/tien-nghich`)
...
```
cd thien-dao/crawlers/metruyenchuvn-crawler && node index.js <story-url> --from <start1> --to <end1>
cd thien-dao/crawlers/metruyenchuvn-crawler && node index.js <story-url> --from <start2> --to <end2>
cd thien-dao/crawlers/metruyenchuvn-crawler && node index.js <story-url> --from <start3> --to <end3>
cd thien-dao/crawlers/metruyenchuvn-crawler && node index.js <story-url> --from <start4> --to <end4>
```
